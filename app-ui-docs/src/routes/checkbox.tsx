...
import source from "../../../lib-ui-react/src/components/ui/checkbox.tsx?raw";
  ...
  return (
    <div className="space-y-8">
      ...
      <section className="space-y-3">
        ...
        <CodeBlock code={"npx shadcn@latest add @akagiyui/checkbox"} lang="bash" />
      </section>
    </div>
  );
}
