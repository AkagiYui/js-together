...
import source from "../../../lib-ui-react/src/components/ui/button-group.tsx?raw";
    ...
    <div className="space-y-8">
      ...
      <section className="space-y-3">
        ...
        <div className="rounded-lg border bg-card p-6 text-card-foreground">
          <DemoRenderer name="button-group" />
        </div>
      </section>
      <section className="space-y-3">
      ...
      <section className="space-y-3">
        ...
        <CodeBlock code={"npx shadcn@latest add @akagiyui/button-group"} lang="bash" />
      </section>
    </div>
  );
}
