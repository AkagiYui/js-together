...
import source from "../../../lib-ui-react/src/components/ui/breadcrumb.tsx?raw";
  ...
  return (
    <div className="space-y-8">
      ...
      <section className="space-y-3">
        ...
        <CodeBlock code={"npx shadcn@latest add @akagiyui/breadcrumb"} lang="bash" />
      </section>
    </div>
  );
}
